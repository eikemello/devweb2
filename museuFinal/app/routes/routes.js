...
module.exports = {
    ...
    registrarAtivo: function (app) {
        app.get('/ativo/atualizar', function (req, res) {
            res.render('./ativo/registrar.ejs', { errors: null, obra: { tipo: '', marca: '', modelo: '', desgaste: ''}});
        });
    },
    ...
    atualizarAtivo: function (app) {
        app.get('/ativo/atualizar2', function (req, res) {
            var q = url.parse(req.url, true);
            let connection = app.config.dbServer();
            obra = {
                id_ativo: q.query['id'],
            }
            console.log("[controller atualizarAtivo] > ", obra);
    ...
    removerAtivo: function (app) {
        app.get('/ativo/remover', function (req, res) {
            ...
            console.log("[controller removerAtivo] > ", obra);
